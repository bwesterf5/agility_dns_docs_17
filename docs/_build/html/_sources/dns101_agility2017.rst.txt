...
Lab components are accessible via HTTPS, SSH or RDP from the Win7
Jumpbox at:

+-------------------------------------+------------------+-----------------------+-------------------+
| **Component**                       | **IP Address**   | **Protocol access**   | **Credentials**   |
+=====================================+==================+=======================+===================+
| gtm1.site1                          | 10.1.10.13       | HTTPS                 | admin/admin       |
+-------------------------------------+------------------+-----------------------+-------------------+
|                                     |                  | SSH                   | root/default      |
+-------------------------------------+------------------+-----------------------+-------------------+
| gtm1.site2                          | 10.1.10.23       | HTTPS                 | admin/admin       |
+-------------------------------------+------------------+-----------------------+-------------------+
|                                     |                  | SSH                   | root/default      |
+-------------------------------------+------------------+-----------------------+-------------------+
| bigip1.site1                        | 10.1.10.11       | HTTPS                 | admin/admin       |
+-------------------------------------+------------------+-----------------------+-------------------+
|                                     |                  | SSH                   | root/default      |
+-------------------------------------+------------------+-----------------------+-------------------+
| bigip2.site1                        | 10.1.10.12       | HTTPS                 | admin/admin       |
+-------------------------------------+------------------+-----------------------+-------------------+
|                                     |                  | SSH                   | root/default      |
+-------------------------------------+------------------+-----------------------+-------------------+
| bigip1.site2                        | 10.1.10.21       | HTTPS                 | admin/admin       |
+-------------------------------------+------------------+-----------------------+-------------------+
|                                     |                  | SSH                   | root/default      |
+-------------------------------------+------------------+-----------------------+-------------------+
| bigip2.site2                        | 10.1.10.22       | HTTPS                 | admin/admin       |
+-------------------------------------+------------------+-----------------------+-------------------+
|                                     |                  | SSH                   | root/default      |
+-------------------------------------+------------------+-----------------------+-------------------+
| dc01.branch01 (domain controller)   | 10.1.70.200      | RDP                   | User/Agility1     |
+-------------------------------------+------------------+-----------------------+-------------------+
| App.example.com                     | 10.1.10.50       | SSH                   | root/default      |
+-------------------------------------+------------------+-----------------------+-------------------+
...
TRAINING PORTAL SCREENSHOT REQUIRED
...
-  **Objective:** Initial setup is based on the static A record in the
   Local DNS based on domain controller. The goal of the lab is to
   enable load balancing across data centers through intelligent dynamic
   DNS resolution.

-  To start off the labs, you will run through some basic configuration
   steps to get **gtm1.site1 (10.1.10.13)** up and operational.
   Networking and NTP are already configured. You will be configuring
   the following:
...
TASK 1 – Get to know the enviroment
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

-  On the Windows Jumpbox run command promt and execure the command
       **dig example.com**. Examine the output.
...
-  Connect to **bigip2.site2**, examine configuration of virtual server
       (**198.51.100.41**) and corresponding pool

-  Try to open `www.example.com <http://www.example.com>`__ from web
       browser on the Windows Jumpbox

TASK 2 – Configuring DNS Logging
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
-  Open Internet Explorer and go to **gtm1.site1 (10.1.10.13)**
...
TASK 7 – Create Generis host server objects
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
