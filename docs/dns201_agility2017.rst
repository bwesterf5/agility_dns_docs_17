...
`DNS LAB – GETTING STARTED 1 <#dns-lab-getting-started>`__

`F5 DNS 201 4 <#f5-dns-201>`__

`EXERCISE 1.1 – AUTHORITATIVE NS: SLAVE FROM OFF-BOX BIND
4 <#exercise-1.1-authoritative-ns-slave-from-off-box-bind>`__

`EXERCISE 1.2 – AUTHORITATIVE NS: SLAVE FROM ON-BOX BIND
14 <#exercise-1.2-authoritative-ns-slave-from-on-box-bind>`__

`EXERCISE 1.3 – SLAVING OFF OF DNS EXPRESS
21 <#exercise-1.3-slaving-off-of-dns-express>`__

`EXERCISE 2.1 – TRANSPARENT CACHING
25 <#exercise-2.1-transparent-caching>`__

`EXERCISE 2.2 – RESOLVER CACHE 34 <#exercise-2.2-resolver-cache>`__

`EXERCISE 2.3 – VALIDATING RESOLVER
37 <#exercise-2.3-validating-resolver>`__

`EXERCISE 2.4 – FORWARDERS 41 <#exercise-2.4-forwarders>`__

`Learn More 43 <#learn-more>`__
